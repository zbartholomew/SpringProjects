...
public class RequestMappingAndParamDemoController {
	...
	// params
	// http://localhost:8080/spring-mvc-request-mapping-param-demo-1/requestMappingAndParamDemo/test6/subtest3?empcount=555&orgname=IBM
	...
	// test 6: subtest 3: Testing with multiple request params and @RequestParam
	// with single param
	...
	// http://localhost:8080/spring-mvc-request-mapping-param-demo-1/requestMappingAndParamDemo/test7?orgname=Canon
